...
class MemoryGame:
    ...
    def show_menu(self):
        ...
        # PIL で画像に文字を描画
        if self.pil_font:
            img = Image.new("RGB", (150, 45), color="silver")
        ...
        tk.Label(settings_frame, text="プレイヤー人数:", 
                font=("liberation sans", 12), width=15, height=2).grid(row=0, column=0, sticky="e")
        ...
        tk.Label(settings_frame, text="行数:", 
                font=("liberation sans", 12), width=15, height=2).grid(row=1, column=0, sticky="e")
        ...
        tk.Label(settings_frame, text="列数:", 
                font=("liberation sans", 12), width=15, height=2).grid(row=2, column=0, sticky="e")
    ...
    def show_game(self):
        ...
        self.timer_label = tk.Label(status_frame, text="00:00", font=("liberation sans", 12))
