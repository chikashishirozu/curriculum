...
class MemoryGame:
    ...
    def show_menu(self):
        ...
        try:        
            ...
            bg_image = Image.open(bg_image_path).resize((900, 700))  # 適切なサイズに調整
    ...
    def show_game(self):
        ...
        self.status_label.pack(side="left", padx=5, pady=(0, 0))
        
        self.timer_label = tk.Label(status_frame, text="00:00", font=("liberation sans", 16))
        self.timer_label.pack(side="right", padx=5, pady=(0, 0))
        ...
        # メニューボタン
        tk.Button(self.game_frame, text="メニューに戻る", bg="#40E0D0", font=(self.custom_font, 14), width=14, height=1, command=self.show_menu).pack(padx=10, pady=(0, 15))
