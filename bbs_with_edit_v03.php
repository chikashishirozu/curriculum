...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (isset($_POST["delete_id"])) {
        ...
        header("Location: bbs_with_edit_v03.php");
        exit;
    }
    ...
    <div class="container">
        <div id="main">
            ...
            <div class="post-form">
                ...
                <form class="form" action="bbs_with_edit_v03.php" method="post">
                    <?php if ($edit_post): ?>
                    ...
                    <div class="d-flex justify-content-end">
                        <div class="btn-group">
                            ...
                            <?php if ($edit_post): ?>
                                <a href="bbs_with_edit_v03.php" class="btn btn-secondary" style="padding: 6px 10px; font-size: 1.2rem; margin: 7px; border: none; border-radius: 5px;">キャンセル</a>
                            <?php endif; ?>
                        </div>
                    </div>
                </form>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group-vertical">
                                        <a href="bbs_with_edit_v03.php?edit_id=<?= $row['id'] ?>" class="btn btn-sm btn-warning">編集</a>
                                        <form action="bbs_with_edit_v03.php" method="post" style="display:inline;">
